...
const PasswordGenerator = lazy(() => import("./pages/apps/passwordGenerator"));
...
const TaskScheduler = lazy(() => import("./pages/apps/taskScheduler"));
const SnakeGame = lazy(() => import("./pages/apps/snakeGame"));
const TenziesGame = lazy(() => import("./pages/apps/tenziesGame"));
...
const FlappyBirdGame = lazy(() => import("./pages/apps/flappyBirdGame"));
...
const HangmanGame = lazy(() => import("./pages/apps/hangmanGame"));
const ImageCompressor = lazy(() => import("./pages/apps/imageCompressor"));
const AspectRatioCalculator = lazy(() => import("./pages/apps/aspectRatioCalculator"));
...
const QuoteGenerator = lazy(() => import("./pages/apps/quoteGenerator"));
const DictionaryApp = lazy(() => import("./pages/apps/dictionaryApp"));
